...
def model_opts(parser):
    ...
    group.add('--multi', '-multi', type=bool, default=False,
              help="")

    group.add('--domain', '-domain', type=bool, default=False,
              help="")
    ...
    group.add('--smooth', '-smooth',type=int,default=0)
...
def train_opts(parser):
    ...
    group.add('--shuffletags', '-shuffletags', required=False,
              help='Path prefix to the ".train.pt" and '
...
def translate_opts(parser):
    ...
    group.add('--ctags', '-ctags',type=str)
    group.add('--threshold', '-threshold',type=float)
    group.add('--len1', '-len1',type=float,default=0.0)
    group.add('--badsynf', '-badsynf',type=str,default=None)
