...
class Translator(object):
    ...
    def _gold_score(self, batch, memory_bank, src_lengths, src_vocabs,
        ...
        if "tgt" in batch.__dict__ and False:
    ...
    def _run_encoder(self, batch,tags):
        src, src_lengths = batch.src if isinstance(batch.src, tuple) \
                           else (batch.src, None)
        print (src.shape)
        enc_states, memory_bank, src_lengths,memory_bank2 = self.model.encoder(
            src, tags,False,src_lengths)
    ...
    def _translate_batch2(self, batch, src_vocabs):
        ...
        beam = [onmt.translate.Beam(
            ...
            stepwise_penalty=self.stepwise_penalty,
            block_ngram_repeat=self.block_ngram_repeat,
            exclusion_tokens=self._exclusion_idxs,tgt=tgt[_i])
