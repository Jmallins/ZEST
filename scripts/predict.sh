...
python ZEST/translate.py --length_penalty avg --beam_size 30  --replace_unk --dynamic_dict --share_vocab  --gpu 0 --model saved_models/model_step_250006.pt  -v --threshold 0 --ctags SIMPLY-SIMPLY-SIMP-SI  --batch_size 20  --max_length 128 --src data/spm/sist.valid.src --output predictions/si-pred-beam-search.txt
