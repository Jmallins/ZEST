...
python ZEST/preprocess.py -train_src /SiTS/spm/spm/trans.en -train_tgt /SiTS/spm/trans.si  -save_data data/EN-TRANS-COMP-SI --src_vocab data/sits.vocab.pt --tgt_vocab data/sits.vocab.pt

python ZEST/preprocess.py -train_src /SiTS/spm/trans.si -train_tgt /SiTS/spm/trans.en  -save_data data/SI-TRANS-COMP-EN --src_vocab data/sits.vocab.pt --tgt_vocab data/sits.vocab.pt

python ZEST/preprocess.py -train_src /SiTS/spm/trans.en -train_tgt /SiTS/spm/trans.en -save_data data/EN-TRANS-COMP-EN --src_vocab data/sits.vocab.pt --tgt_vocab data/sits.vocab.pt
...
python ZEST/preprocess.py -train_src /SiTS/spm/trans.si -train_tgt /SiTS/spm/trans.si  -save_data data/SI-TRANS-COMP-SI --src_vocab data/sits.vocab.pt --tgt_vocab data/sits.vocab.pt
...
python ZEST/preprocess.py -train_src /SiTS/spm/trans.en -train_tgt /SiTS/spm/trans.en -save_data data/EN-LM-COMP-EN --src_vocab data/sits.vocab.pt --tgt_vocab data/sits.vocab.pt
...
python ZEST/preprocess.py -train_src /SiTS/spm/trans.si -train_tgt /SiTS/spm/trans.si  -save_data data/SI-LM-COMP-SI --src_vocab data/sits.vocab.pt --tgt_vocab data/sits.vocab.pt
