...
def build_dataset_iter(path,fields, opt,is_train=True):
    """
    ...
    return DatasetLazyIter(
        ...
        num_batches_multiple=opt.accum_count * opt.world_size,size=len(dataset_paths))
