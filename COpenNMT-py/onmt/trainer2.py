...
def build_trainer2(opt, device_id, model, fields, optim, model_saver=None):
    """
...
class Trainer2(object):
    ...
    def train(self,
        ...
        cadam = optim.Adam(self.Critic(), lr=0.0001)
        ...
        while not (train_steps > 0 and step >= train_steps):
            ...
            for jjj,(tags,bn,skip) in enumerate(bns):
                ...
                if valid_iter is not None and step % valid_steps == 0 and jjj==0:
                ...
                if (self.model_saver is not None
                    and (save_checkpoint_steps != 0
                         and step % save_checkpoint_steps == 0) and jjj==0):
    ...
    def _gradient_accumulation(self, true_batches, normalization, total_stats,
        ...
        for batch in true_batches:
            ...
            for j in range(0, target_size-1, trunc_size):
                ...
                if self.grad_accum_count == 1:
                    self.optim.zero_grad()
                outputs, attns,encstate = self.model(src, tgt, src_lengths, tags=tags,bptt=bptt)
                bptt = True
